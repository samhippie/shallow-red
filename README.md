A Pokemon Showdown AI that uses Monte Carlo tree search to make moves. It is assumed that both players have access to both team sheets. Right now it only supports the 1v1 format.
