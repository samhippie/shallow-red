...
async def main():
    ...
    await deepRunner.playTestGame(teams, format=format, limit=100, numProcesses=3, advEpochs=1000, stratEpochs=20000, branchingLimit=None, depthLimit=5, initMoves=initMoves)
