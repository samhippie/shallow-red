...
async def main():
    ...
    await deepRunner.playTestGame(teams, format=format, limit=30, numProcesses=3, advEpochs=100, stratEpochs=20000, branchingLimit=None, depthLimit=5, initMoves=initMoves)
